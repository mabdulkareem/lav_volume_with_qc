...
def vgg16_model(INPUTS, NO_OUTPUT_LAYER_UNITS, with_last_activation): 
    ...
    base_model =  VGG16(include_top=False,   # whether to include the 3 fully-connected layers at the top of the network.
...
def vgg19_model(INPUTS, NO_OUTPUT_LAYER_UNITS, with_last_activation): 
    ...
    # load the base VGG16 model
    base_model =  VGG19(include_top=False,   # whether to include the 3 fully-connected layers at the top of the network.
                        weights=None,        # 'None' (random initialization), or 
                                             # the path to the weights file to be loaded.
                        input_shape=INPUTS)
...
def resnet50_model(INPUTS, NO_OUTPUT_LAYER_UNITS, with_last_activation):
    ...
    base_model =  ResNet50(include_top=False,   # whether to include the 3 fully-connected layers at the top of the network.
                           weights=None,        # 'None' (random initialization), or 
                                                # the path to the weights file to be loaded.
                           input_shape=INPUTS)
