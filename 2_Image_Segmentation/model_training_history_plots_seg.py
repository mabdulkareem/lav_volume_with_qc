...
def training_history_plots(model_training_history, save_img_path): 
    ...
    acc = model_training_history.history['accuracy'] # tf.keras.metrics.Accuracy()
    loss = model_training_history.history['loss'] # tf.keras.losses.SparseCategoricalCrossentropy()
